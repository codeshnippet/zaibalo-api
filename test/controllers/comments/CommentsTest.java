...
public class CommentsTest extends FunctionalTest{
	...
	public void testGetPostComments(){
		...
		assertContentEquals("[{\"id\":"+comment.id+",\"content\":\"Funny comment!\",\"author\":{\"id\":" + comment.author.id + ",\"displayName\":\"Superman\",\"photo\":\"https://s3.eu-central-1.amazonaws.com/z-avatars/default.jpg\",\"loginName\":\"franky\",\"photoProvider\":\"AVATARS_IO\"},\"creationTimestamp\":1238025600000,\"ratingSum\":0,\"ratingCount\":0,\"selfRef\":\"/comments/"+comment.id+"\"}]", response);
	}
