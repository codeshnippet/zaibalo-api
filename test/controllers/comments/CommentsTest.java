...
public class CommentsTest extends FunctionalTest{
	...
	public void testGetPostComments(){
		...
		assertContentEquals("[{\"id\":"+comment.id+",\"content\":\"Funny comment!\",\"author\":{\"id\":" + comment.author.id + ",\"displayName\":\"Superman\",\"photo\":\"https://s3.eu-central-1.amazonaws.com/z-avatars/default.jpg\",\"loginName\":\"franky\",\"photoProvider\":\"ZAIBALO\",\"about\":\"-\",\"postsCount\":0,\"commentsCount\":0},\"creationTimestamp\":1238025600000,\"selfRef\":\"/comments/"+comment.id+"\"}]", response);
	}
